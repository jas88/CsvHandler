...
// This is a polyfill implementation for netstandard2.0 compatibility.
...
namespace CsvHandler.Compat
{
    ...
    {
        private const int ArrayMaxLength = 0x7FFFFFC7; // Copy of Array.MaxLength from CoreLib.
        ...
        /// <summary>
        /// Resets the count of written items without clearing the underlying buffer.
        /// </summary>
        /// <remarks>
        /// This method is less safe than <see cref="Clear"/> and should only be used when you know
        /// the buffer will be completely overwritten.
        /// </remarks>
        ...
        /// </remarks>
        /// <remarks>
        /// There is no guarantee that successive calls will return the same buffer or the same-length buffer.
        /// </remarks>
        /// <remarks>
        /// You must request a new buffer after calling Advance to continue writing more data and cannot write to a previously acquired buffer.
        /// </remarks>
        ...
        private void CheckAndResizeBuffer(int sizeHint)
        {
            ...
            if (sizeHint > FreeCapacity)
            {
                ...
                {
                    // Attempt to allocate the maximum array size.
                    // If the requested size is larger, throw an OutOfMemoryException.
